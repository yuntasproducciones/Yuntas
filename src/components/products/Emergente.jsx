...
const Emergente = ({ producto }) => {
 ...
 const textoData = useMemo(() => getTextoPromocional(), []);
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-3xl shadow-lg w-[90vw] max-w-4xl overflow-hidden flex flex-col md:flex-row">
  {/* Imagen del popup con marco blanco y diagonal */}
  <div className="relative w-full md:w-1/2 h-64 md:h-auto overflow-hidden rounded-3xl">
    {/* Marco blanco completo */}
    <div className="absolute inset-0 border-8 border-white z-10 pointer-events-none rounded-3xl"></div>

    {/* Triángulo con mismo borde blanco */}
    <div
      ...
      style={{
        ...
        borderBottom: '600px solid white',
  ...
  <div className="w-full md:w-1/2 bg-white p-8 flex flex-col justify-center relative rounded-3xl">
    <button
      onClick={onClose}
    ...
    <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-3 rounded-md border-4 ${
