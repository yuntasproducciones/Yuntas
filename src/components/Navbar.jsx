...
const Navbarjsx = ({ logo, variant = "default" }) => {
...
const headerClasses =
  variant === "admin" ? "w-full z-20" : "fixed w-full z-20";
  return (
    <header className={headerClasses}>
      ...
      <nav
        ...
        } flex-col gap-y-4 absolute top-20 left-0 right-0 justify-center items-center w-full ${
          darkMode
            ? "bg-gray-900/95"
