            ...
            {loading ? (
              ...
              currentItems.map((item, idx) => (
                ...
                >
                  <td
                    data-label="ID"
                    className="px-4 py-2 font-bold border-b border-gray-200 block md:table-cell relative md:static 
                    before:content-[attr(data-label)] before:font-semibold before:text-gray-600 before:block md:before:hidden"
                  >
                    {item.id}
                  </td>
                  <td
                  ...
                  <td
                    ...
                    className="px-4 py-2 border-b border-gray-200 block md:table-cell relative md:static 
                    before:content-[attr(data-label)] before:font-semibold before:text-gray-600 before:block md:before:hidden"
                  >
                  ...
                  <td
                    data-label="Fecha"
                    className="px-4 py-2 border-b border-gray-200 text-sm block md:table-cell relative md:static 
                    before:content-[attr(data-label)] before:font-semibold before:text-gray-600 before:block md:before:hidden"
                  >
                    {item.created_at
                  ...
                  <td
                    data-label="Acción"
                    className="px-4 py-3 block md:table-cell relative md:static 
                    before:content-[attr(data-label)] before:font-semibold before:text-gray-600 before:block md:before:hidden"
                  >
